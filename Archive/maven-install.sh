...
wget https://raw.githubusercontent.com/marcelineepi/realworld-cicd-pipeline-project1/jenkins-master-client-config/archive/maven-install.md -P /home/jenkinsmaster/.m2/
